// Adapter from progression intents to versioned journal.
function appendIntents(journal, intents, context, eventModel) {
  if (!eventModel || typeof eventModel.createEvent !== "function") throw new Error("eventModel: compatible EventModel is required");
...
if (typeof module !== "undefined" && module.exports) module.exports = { appendIntents: appendIntents };
